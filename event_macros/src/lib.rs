...
pub fn event_processor(_args: TokenStream, input: TokenStream) -> TokenStream {
    event_processor_actual(input.into()).into()
}
fn event_processor_actual(input: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
...
mod tests {
    ...
    fn debug_macro_output() {
        ...
        let output = event_processor_actual(input);
